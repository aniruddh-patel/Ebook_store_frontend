  ...
  const items = [
    {
      ...
      content:
        "Yes, all the PDFs available on our website are completely free to download. We believe in providing free access to knowledge and literature for everyone.",
    },
    {
      title: "Do I need to create an account to download the PDFs?",
      content:
        "yes, you do need to create an account to download the PDFs. Simply create account ,browse our collection, select the book you want, and click the download link to get your free copy.",
    },
    {
      title: "What formats are the books available in?",
      content:
        "Our books are primarily available in PDF format for easy reading and compatibility with most devices. However, we are working on adding more formats like EPUB and MOBI in the future.",
    },
    {
      title: "Are the PDFs legal to download?",
      content:
        "Yes, all the PDFs on our website are legally distributed. We either own the rights to the books, or they are available under public domain or open-access licenses.",
    },
    {
      title: "Can I share the PDFs with others?",
      content:
        "Yes, you are welcome to share the PDFs with others. Our goal is to spread knowledge and make it accessible to as many people as possible. However, please do not sell or alter the files in any way.",
    },
  ];
  return (
      ...
      <div className="contactus-inner-box">
        ...
        <div className="contactus-privacy-div">
          <div className="cookies-policy">
            ...
            <p>
              Our website, Study Buzz ("us", "we", or "our"), uses cookies to
              enhance your browsing experience and improve our services. This
              Cookies Policy explains what cookies are, how we use them, and
            ...
            <p>
              ...
              the website recognize your device and remember your preferences
              over time.
            </p>
            ...
            <ul>
              <li>
                <strong>Authentication:</strong> To recognize when you log in to
                our website and provide you with access to the content and
              ...
              <li>
                <strong>Analytics:</strong> To analyze how our website is used
            ...
            <ul>
              <li>
                ...
                usually set in response to actions made by you, such as logging
                in or filling out forms.
              </li>
              <li>
                <strong>Performance Cookies:</strong> These cookies collect
                information about how visitors use a website, for instance,
                which pages visitors go to most often, and if they get error
                messages from web pages. These cookies do not collect
                information that identifies a visitor. All information these
                cookies collect is aggregated and therefore anonymous. It is
              ...
              <li>
                ...
                changes you have made to text size, fonts, and other parts of
                web pages that you can customize.
              </li>
              <li>
                <strong>Targeting Cookies:</strong> These cookies are used to
                deliver ads more relevant to you and your interests. They are
                ...
                campaign. They are usually placed by advertising networks with
                the website operator’s permission. They remember that you have
            ...
            <p>
              ...
              visit <a href="https://en.wikipedia.org/wiki/HTTP_cookie">here</a>
              .
            </p>
          </div>
        </div>
        <div className="contactus-policy-div">
          <div className="terms-of-use">
            ...
            <p>
              Welcome to Study Buzz. By accessing or using our website, you
              agree to comply with and be bound by the following terms and
              conditions of use, which together with our privacy policy govern
              Study Buzz's relationship with you in relation to this website.
            </p>
            ...
            <p>
              ...
              data compilations, and software, is the property of Study Buzz or
              ...
              property of Study Buzz and protected by international copyright
              laws.
            </p>
            ...
            <p>
              ...
              access to the website at our sole discretion, without notice and
              for any reason, including, but not limited to, breach of these
              terms.
            </p>
            ...
            <p>
              ...
              Study Buzz makes no representations or warranties of any kind,
            ...
            <p>
              To the full extent permissible by applicable law, Study Buzz
              disclaims all warranties, express or implied, including, but not
              limited to, implied warranties of merchantability and fitness for
              a particular purpose. Study Buzz does not warrant that this site,
              its servers, or e-mail sent from Study Buzz are free of viruses or
              other harmful components. Study Buzz will not be liable for any
        ...
        <div className="contactus-policy-div">
            <div className="terms-of-use">
              <h1>CRPYTO ADDRESS</h1>
              <p>
                <strong>Last updated: {Date()}</strong>
              </p><br />
              <h3>BITCOIN ADDRESS: SHFGKAEGFJEFAEF56E8FA5</h3>
              <h3>LITECOIN ADDRESS: BDSFS5G4S5D2FGS6D5G2SF6G</h3>
            </div>
          </div>
      </div>
    </div>
